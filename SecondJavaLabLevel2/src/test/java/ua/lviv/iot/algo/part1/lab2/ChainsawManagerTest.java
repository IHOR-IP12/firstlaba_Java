...
class ChainsawManagerTest {
    ...
    void setUp() {
        ...
        saw1 = new Chainsaw("Stihl", 1000, 5, 2);
        saw2 = new Chainsaw("Husqvarna", 1500, 3, 3);
        saw3 = new Chainsaw("Makita", 2000, 4, 4);
    ...
    @Test
    void testGetSawList() {
        Chainsaw saw1 = new Chainsaw("Brand 1", 2000, 2.0, 5.0);
        Chainsaw saw2 = new Chainsaw("Brand 2", 1800, 1.5, 4.0);
        Chainsaw saw3 = new Chainsaw("Brand 3", 2200, 2.5, 6.0);
    ...
    void testFindAllWithBrand() {
        Chainsaw saw1 = new Chainsaw("Stihl", 1200, 4.5, 10);
        Chainsaw saw2 = new Chainsaw("Husqvarna", 1400, 5.0, 12);
        Chainsaw saw3 = new Chainsaw("Stihl", 1100, 4.0, 8);
        Chainsaw saw4 = new Chainsaw("Echo", 1300, 4.5, 9);
