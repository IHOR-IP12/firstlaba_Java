...
public class ChainsawTest {
    ...
    @Test
    void testChainsaw() {
        Chainsaw chainsaw = new Chainsaw("Stihl", 2.5, 60, 500);
    ...
    public void testFuelTankCapacity() {
        ...
        Chainsaw chainsaw = new Chainsaw("Stihl", 2.5, 1.0, expectedFuelTankCapacity);
    ...
    public void testStop() {
        Chainsaw chainsaw = new Chainsaw("Stihl", 2.5, 1.0, 2.0);
        chainsaw.start();
        assertTrue(chainsaw.isWorking());
        chainsaw.stop();
        assertFalse(chainsaw.isWorking());
    ...
    public void testGettersAndSetters() {
        Chainsaw chainsaw = new Chainsaw("null", 2.5, 1.0, 2.0);
